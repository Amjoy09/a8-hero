...
const Banner = () => {
  return (
    <div>
      <h1 className="text-[50px] md:text-[72px] leading-18 font-bold text-center mt-10">
      ...
      <div className="bg-linear-to-r from-[#632EE3] to-[#9F62F2] ">
        <h1 className="text-center text-white text-[45px] md:text-[55px] font-semibold pt-10">Trusted by Millions, Built for You</h1>
       <div className="flex flex-col md:flex-row gap-17 md:justify-between justify-center w-5/12 md:w-8/12 mx-auto py-14">
         <div className="text-center">
            <p className="text-[28px] text-white">Total Downloads</p>
            <h1 className="text-[72px] font-bold text-white">29.6M</h1>
            <p className="text-[18px] text-gray-300">21% more than last month</p>
        </div>
        <div className="text-center">
            <p className="text-[28px] text-white">Total Reviews</p>
            <h1 className="text-[72px] font-bold text-white">906K</h1>
            <p className="text-[18px] text-gray-300">46% more than last month</p>
        </div>
        <div className="text-center">
            <p className="text-[28px] text-white">Active Apps</p>
