...
const Banner = () => {
  return (
    <div>
      ...
      <p className="text-center mx-auto mt-6 mb-9 text-[16px] w-[800px] text-[#627382]">
        At HERO.IO, we craft innovative apps designed to make everyday life
        simpler, smarter, and more exciting. Our goal is to turn your ideas into
        digital experiences that truly make an impact.
      </p>
      <div className="BANNER-BUTTONS flex gap-3 w-max mx-auto">
      ...
      <div className="bg-linear-to-r from-[#632EE3] to-[#9F62F2] ">
       ...
       <div className="flex justify-between w-[1000px] mx-auto py-14">
